...
const TShirtEditor: React.FC = () => {
  ...
  console.log({ size });
  const { color, view, setColor, setView, addTextElement, addImageElement } =
    useTShirtStore();
    ...
    <>
      <div className="bg-grey">
        <div className=" min-h-screen flex flex-col items-center pb-6">
          ...
          <div className=" left-3 top-20 p-6 ">
            {activeTab === "Product" && (
              <div className="bg-white border border-gray-300 rounded-2xl p-6 shadow-lg max-w-md">
                ...
                <div className="mt-4">
                  <h3 className="font-medium">Size (Small)</h3>
                  <div className="flex gap-2 mt-2">
                    <button className="border border-blue-500 text-blue-500 px-4 py-2 rounded-lg shadow-sm">
                      S
                    </button>
